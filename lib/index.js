...
/**
 * PhoneNumberUtils
 * @type {{initConfig: module.exports.initConfig, isValid: module.exports.isValid, isMobile: module.exports.isMobile, toE164: module.exports.toE164, toNationalNumber: module.exports.toNationalNumber, PhoneNumberType: *, getType: module.exports.getType, getCountryCode: module.exports.getCountryCode, hlrLookup: module.exports.hlrLookup}}
 */
module.exports = {
   ...
   * @returns {Boolean|Object[]} - In case {@link numbers} is a string it returns a Boolean indicating if the number is valid or not. Throws error in case of error.
   ...
   *  },
   * ]
   * @throws {Error|TypeError} - In case numbers is a string it throws errors that occure in validation of input as wel las in process of checking. In case numbers is a string array, error is thrown if numbers is empty array otherwise an object {isError: true, error {Error}} is put into the returned array.
   */
  isValid: function isValid(numbers, regionCode) {
    if (_.isArray(numbers) && !_.isEmpty(numbers)) {
      return _.map(numbers, function (number) {
        var result = {};
        try {
          result.isValid = pnValidator.isValid(number, regionCode);
      ...
      return pnValidator.isValid(numbers, regionCode);
    }
  },
