...
var PhoneNumberUtils = function PhoneNumberUtils(options) {
  ...
  if (!_.isObject(pUtilsOptions) || _.isArray(pUtilsOptions)) {
    ...
    pnValidator = PNValidator.createInstance(pUtilsOptions);
    pnExtractor = PNExtractor.createInstance(pUtilsOptions);
    pnFormatter = PNFormatter.createInstance(pUtilsOptions);
  } else {
    pnValidator = PNValidator.createInstance();
    pnExtractor = PNExtractor.createInstance();
    pnFormatter = PNFormatter.createInstance();
  }
