...
var providers = {
  smsApi: new smsApiProvider('smsapi.com', process.env.SMSAPI_USERNAME, process.env.SMSAPI_HASHED_PASSWORD),
  hlrLookups: new hlrLookupsProvider('hlr-lookups.com', process.env.HLR_LOOKUPS_USERNAME, process.env.HLR_LOOKUPS_PASSWORD)
};
