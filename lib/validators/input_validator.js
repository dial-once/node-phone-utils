...
var MIN_NUMBER_LEN = 2;
var MAX_SHORT_NUBER_LEN = 5;
...
InputValidator.isShortNumber = function isShortNumber (phoneNumber){
  return _.isString(phoneNumber) &&  phoneNumber.length > MAX_SHORT_NUBER_LEN && phoneNumber.length <MAX_SHORT_NUBER_LEN;
};
