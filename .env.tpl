...
# Set option ENABLE_HLR_LOOKUPS to false to make sure no actual requests are made by HLR lookup providers that might cost you money. The calls will then return dummy data.
